...
export function DangerButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={disabled || loading}
      className="w-full rounded-lg border border-danger/40 bg-danger/10 px-4 py-2.5 text-sm font-medium text-danger transition-colors hover:bg-danger/20 disabled:opacity-50"
    >
