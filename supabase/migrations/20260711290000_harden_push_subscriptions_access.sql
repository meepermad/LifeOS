-- Harden push_subscriptions: block direct authenticated table access.
-- Clients use RPC functions that return only safe device summaries.
-- Cron push delivery continues via service-role direct table access.

-- ---------------------------------------------------------------------------
-- Revoke direct authenticated access to sensitive subscription secrets
-- ---------------------------------------------------------------------------
revoke select, insert, update, delete on table public.push_subscriptions
  from authenticated;
...
-- RLS remains enabled; service role bypasses RLS for cron delivery.

-- ---------------------------------------------------------------------------
-- register_push_subscription — upsert by endpoint for auth.uid()
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- list_push_device_summaries — safe columns only
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- deactivate_push_subscription — by opaque device id
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- deactivate_push_subscription_by_endpoint — current device unsubscribe
-- ---------------------------------------------------------------------------
